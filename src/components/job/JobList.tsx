...
//   const updateSkill = (index: number, field: "name" | "mark", value: string | number) => {
//     const updated = [...skills];
//     updated[index][field] = field === "mark" ? +value : value as string;
//     setSkills(updated);
//   };
...
//               max={10}
//               value={numCandidate}
//               onChange={(e) => setNumCandidate(+e.target.value)}
//             />
//           </div>
...
//                 type="number"
//                 value={skill.mark}
//                 onChange={(e) => updateSkill(index, "mark", e.target.value)}
//               />
...
//           <br />
//           <button type="submit" style={{ marginTop: 10 }}>🚀 הוסף משרה</button>
//         </form>
//       )}
...
const updateSkill = (index: number, field: "name" | "mark", value: string) => {
  const updated = [...skills];
  if (field === "mark") {
    updated[index][field] = +value; // המרה למספר
  } else {
    updated[index][field] = value;  // מחרוזת
  }
  setSkills(updated);
};
